...
export default function YetiizeLoading() {
  ...
  return (
    <>
      ...
      <div className="mountains-of-christmas-bold text-outline z-20 col-span-9 col-start-1 row-start-7 grid items-center justify-center text-9xl text-white drop-shadow-[0_13px_13px_rgba(0,0,0,1)]">
